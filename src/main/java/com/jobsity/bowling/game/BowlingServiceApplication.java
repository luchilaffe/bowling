 ...
 * 
 * The program reads the input text file and parse its content, 
 * which should have the results for several players bowling 10 frames each.
 * 
 * The program handles bad input like more than ten throws (i.e., no chance 
 * will produce a negative number of knocked down pins or more than 10, etc),
